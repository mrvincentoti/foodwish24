 ...
 * @property \App\Model\Table\OdersTable|\Cake\ORM\Association\BelongsTo $Oders
 *
...
class TransactionsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->dateTime('oder_date')
            ->requirePresence('oder_date', 'create')
            ->notEmpty('oder_date');

        $validator
            ->scalar('gresponse')
            ->maxLength('gresponse', 16)
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['oder_id'], 'Oders'));
